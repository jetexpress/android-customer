...
public abstract class BaseHasBasicLayoutFragment extends BaseFragment
{
    ...
    protected void showRetry(Integer stringResourceId)
    {
        if (hasBasicLayout())
        {
            ...
            base_text_view_retry_info.setText(JETApplication.getContext().getString(stringResourceId));
